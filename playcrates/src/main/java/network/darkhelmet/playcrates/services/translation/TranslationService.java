...
package network.darkhelmet.playcrates.services.translation;
...
import network.darkhelmet.playcrates.services.configuration.PlayCratesConfiguration;
...
public class TranslationService implements IMessageSource<CommandSender, String> {
     ...
     * @param playCratesConfiguration The default locale
     * @throws IOException IO Exception
     */
    @Inject
    public TranslationService(
        Logger logger, Path dataDirectory, PlayCratesConfiguration playCratesConfiguration) throws IOException {
        this.logger = logger;
        this.dataDirectory = dataDirectory;
        this.defaultLocale = playCratesConfiguration.defaultLocale();
